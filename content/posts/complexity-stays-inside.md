...
Ложная простота возникает, когда продукт показывает красивый результат, но не объясняет ограничения, не даёт проверить источник и не сообщает об uncertainty.
