...
4. CTA-блок: переход на Pro-leads или Tender Audit, с одной фразой "почему сейчас"
...
Тексты для этих 5 материалов и для страницы "Обо мне" готовятся отдельно — не входят в
данный документ, будут собраны в следующей итерации.
