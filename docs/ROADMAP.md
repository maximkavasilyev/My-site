...
- [ ] Текст для страницы "Обо мне" (личная история, путь, экспертиза)
- [ ] Краткие описания для карточек "Проекты" (Pro-leads, Tender Audit — 1 абзац на каждый)
- [ ] 3-5 первых постов для блога (черновой список тем — в CONTENT_GUIDE.md)
